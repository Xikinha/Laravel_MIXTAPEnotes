    ...
    @auth
        ...
        <form class="mt-0 w-full" method="POST" action="{{ route('storeNotes') }}">
            ...
            <div class="flex flex-col items-center justify-center py-4">
                <button type="submit" class="mt-5 rounded-md bg-black px-4 py-2 text-white text-sm font-semibold hover:bg-green-600 hover:text-black focus:outline-none focus:text-white focus:bg-gray-700">Update</button>
            </div>
        </form>
